  ...
  return (
    <div className="container">
      ...
      <div className="sidebar">
        ...
        <button onClick={handleEnableDraw}>Drawing</button>
...
<button onClick={() => handleResize(canvasWidth, canvasHeight)}>Resize Canvas</button>
<button onClick={() => setIsCrropping(true)}>Crop</button>
<button onClick={handleUndo} disabled={presentIndex <= 0}>Undo</button>
